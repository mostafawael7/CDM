  ...
  <section class="home-section">
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div>
          <form action="NANSC_add.php" method="POST">
            <input type="text" class="modal_field" placeholder="Airport..." name="airport_field" required>
            <input type="text" class="modal_field" placeholder="Operation Manager..." name="op_manager_field" required>
            <input type="text" class="modal_field" placeholder="Telephone..." name="tele_field" required>
            <input type="text" class="modal_field" placeholder="Letter of Agreement..." name="LOA_field" required>
    ...
    $result = mysqli_query($con, "SELECT * FROM NANSC_Airports");
    ...
    while ($row = mysqli_fetch_array($result)) {
      ...
      echo "<td>" . $row['operation_manager'] . "</td>";
      echo "<td>" . $row['telephone'] . "</td>";
      echo "<td>" . $row['letter_of_agreement'] . "</td>";
      echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
