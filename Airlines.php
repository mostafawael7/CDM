  ...
  <section class="home-section">
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div>
          <form action="Airlines_add.php" method="POST">
            <input type="text" class="modal_field" placeholder="Airline..." name="airline_field" required>
            ...
            <input type="text" class="modal_field" placeholder="Operator..." name="operator_field" required>
